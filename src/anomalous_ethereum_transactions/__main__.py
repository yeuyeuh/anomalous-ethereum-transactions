"""Anomalous Ethereum Transactions file for ensuring the package is executable
as `anomalous-ethereum-transactions` and `python -m anomalous_ethereum_transactions`
"""
import importlib
