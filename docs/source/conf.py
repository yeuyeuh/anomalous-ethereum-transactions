...
# anomalous_ethereum_transactions documentation build
...
from anomalous_ethereum_transactions import __version__ as release

# -- Project information -----------------------------------------------------

project = "anomalous_ethereum_transactions"
author = "Kedro"
...
htmlhelp_basename = "anomalous_ethereum_transactionsdoc"
...
latex_documents = [
    (
        master_doc,
        "anomalous_ethereum_transactions.tex",
        "anomalous_ethereum_transactions Documentation",
        "Kedro",
        "manual",
    )
]
...
man_pages = [
    (
        master_doc,
        "anomalous_ethereum_transactions",
        "anomalous_ethereum_transactions Documentation",
        [author],
        1,
    )
...
texinfo_documents = [
    (
        ...
        author,
        "anomalous_ethereum_transactions",
        "Project anomalous_ethereum_transactions codebase.",
        "Nearest-Neighbour",
    )
]
